...
public final class SmithWaterman {
    ...
    public SmithWaterman(String q, String t) throws IOException, Exception {
  ...
  void printMats()
     {
         int i,j;
         int l=query.strlength;
         int m=template.strlength;
         System.out.printf("score matrix  : ");
          System.out.printf("\n ");
           
         System.out.print("\t\t");
      
           for(i=0;i<m;i++)
               System.out.print(template.text[i]+"\t");
          System.out.printf("\n ");
          System.out.print("\t");
          for(i=0;i<i+1;i++)
         {
             if(i>0)
             System.out.print(query.text[i-1]+"\t");
            for(j=0;j<m+1;j++)
            {
                System.out.print(score[i][j]+"\t");
            }
          ...
          System.out.println("*********************************************************************");
          System.out.printf("pointer matrix");
          System.out.printf("\n ");
          System.out.print("\t\t");
